...
1. **Create Personal Access Token:**
   ...
   - **Note:** `django-basecoat-development`
...
2. **Add token to GitHub Secrets:**
   ...
   - Go to your repository: [github.com/IgnaceMaes/django-basecoat/settings/secrets/actions](https://github.com/IgnaceMaes/django-basecoat/settings/secrets/actions)
...
1. **Create PyPI API Token:**
   ...
   - Click "Add API token"
   - **Token name:** `django-basecoat-publish`
...
1. **Get Codecov Token:**
   ...
   - Go to [codecov.io/gh/IgnaceMaes/django-basecoat/new](https://codecov.io/gh/IgnaceMaes/django-basecoat/new)
...
```bash
git remote add origin git@github.com:IgnaceMaes/django-basecoat.git
git branch -M main
